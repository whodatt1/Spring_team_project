...
<div class="py-3 px-5">
	...
	<div class="dropdown my-dropdown movie">
		<a class="my-btn" href="" role="button" data-bs-toggle="dropdown"
			aria-expanded="false"> 장르 선택 </a>
	...
	<div class="row" id="movieListArea">
		<c:forEach items="${phd.list}" var="mvo">
			<a
				href="/movies/detail?mno=${mvo.mno }&pageNo=${pgn.pgvo.pageNo}&qty=${pgn.pgvo.qty}&genre=${pgn.pgvo.genre}"
	...
	<div style="text-align: center; margin-top: 30px;">
		<button type="button" id="moreBtn" data-page="1"
			...
			class="btn btn-outline-secondary btn-block w-100">MORE +</button>
	</div>
</div>
